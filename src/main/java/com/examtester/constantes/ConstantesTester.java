...
public class ConstantesTester {
	...
	public static final String CONST_ID_SUBTEMA_TOPICO = "ID_SUBTEMA_TOPICO";
	public static final String CONST_ID_ORIGEN = "ID_ORIGEN";
	public static final String CONST_PREGUNTA = "PREGUNTA";
	public static final String CONST_IMAGEN_P = "IMAGEN_PREGUNTA";
	public static final String CONST_IMAGEN_A = "IMAGEN_RESP_A";
	...
	public static final String CONST_TOTAL_PREGUNTAS = "TOTAL_PREGUNTAS";
	public static final String CONST_ORIGEN = "ORIGEN";
	public static final String CONST_NOMBRE_SUBTEMA = "NOMBRE_SUBTEMA";
	public static final String CONST_NOMBRE_TEMA = "NOMBRE_TEMA";
